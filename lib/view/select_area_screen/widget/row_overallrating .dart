...
class OverALLRatingRow extends StatelessWidget {
  const OverALLRatingRow({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Text(StringManger.overallRating, style: GoogleFonts.montserrat(
            fontSize: 14.sp,
