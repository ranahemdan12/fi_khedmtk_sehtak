...
class SubsExpansion extends StatefulWidget {
  const SubsExpansion({Key? key}) : super(key: key);

  @override
  State<SubsExpansion> createState() => _SubsExpansionState();
}

class _SubsExpansionState extends State<SubsExpansion> {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        child: ExpansionTile(title: Text(StringManger.subspecialties),
